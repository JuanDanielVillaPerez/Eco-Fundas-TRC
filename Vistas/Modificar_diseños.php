...
<body style="background-color: black;">
				...
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item dropdown">
        				...
        				<div class="dropdown-menu" aria-label-ledby="navbarDropdown" style="background-color:yellow;">
        					...
        					<a class="dropdown-item" href="#">Modificar diseños</a>
	...
	<div class="container">
		<div>
			<form action="../Procesos/insertar_diseños.php" class="formulario" method="POST">
		        <input type="submit" value="Agregar diseño" class="btn btn-primary">
			</form>
		</div>
		<br>
		<div class="table-responsive">
			<table class="table table-striped|table-bordered|table-hover|table-sm">
			<caption>Listado de diseños</caption>
				...
				<tbody style="background-color: white;">
					...
					<tr>
						<th><?php echo $fila['DiseñoID']; ?></th>
						<th><?php echo $fila['Tipo']; ?></th>
						<th><?php echo $fila['NombreDiseño']; ?></th>
						<th><img width="250px" height="250px" src="data:image/png;base64,<?php echo base64_encode($fila['Imagen']); ?>" alt="Responsive image"></th>
						<th><a href="../Procesos/deleteimg.php?id=<?php echo $fila['DiseñoID']; ?>" class="btn btn-danger">Eliminar</a></th>
					</tr> 
					<?php endforeach ?>
				</tbody>
			</table>
