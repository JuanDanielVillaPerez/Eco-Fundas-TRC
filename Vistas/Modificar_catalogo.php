				...
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item dropdown">
        				...
        				<div class="dropdown-menu" aria-label-ledby="navbarDropdown" style="background-color:yellow;">
        					...
        					<a class="dropdown-item" href="#">Modificar catalogo</a>
	...
	<div class="container">
		<div>
			<form action="#" class="formulario" method="post">
		        <a href="../Procesos/insertar_marca.php" class="btn btn-primary">Agregar marca</a>
				<a href="../Procesos/insertar_modelo.php" class="btn btn-primary">Nuevo modelo</a>
			</form>
		</div>
		<br>
		<div class="table-responsive">
			<table class="table table-striped|table-bordered|table-hover|table-sm">
			  ...
			  <tbody class="" style="background-color: white;">
			  	<?php	
				$query="select * from Marca inner join Modelo on Marca.MarcaID = Modelo.MarcaID";
				...
				<tr>
					<td><?php echo $fila['ModeloID']; ?></td>
					<td><?php echo $fila['NombreMarca']; ?></td>
					<td><?php echo $fila['NombreModelo']; ?></td>
					<td><a href="../Procesos/update.php?id=<?php echo $fila['ModeloID']; ?>" class="btn btn-success">Editar</a></td>
					<td><a href="../Procesos/delete.php?id=<?php echo $fila['ModeloID']; ?>" class="btn btn-danger">Eliminar</a></td>
				</tr>
				<?php endforeach ?>
			  </tbody>
			</table>
