...
if (isset($_POST['guardar'])) {
	$nombremarca=$_POST['nombremarca'];
		...
		$inserta_marca="insert into Marca(NombreMarca) values('$nombremarca')";

		$db->ejecutaSQL($inserta_marca);
...
<br><br>
	<div class="container" align="center">
		<form action="" method="POST" align="center" style="background-color: yellow; width:300px;">
		<div class="form-group"><br>
		<h2>Insertar marca</h2><br>
			<div class="form-group">
				<input type="text" name="nombremarca" placeholder="Inserte la marca" required autofocus>
			</div>
