...
if (isset($_GET['id'])) {
	...
	$editar_modelo="update `EcoFundas`.`Modelo` set `MarcaID` = '$marcaid', `NombreModelo` = '$nombremodelo' WHERE (`ModeloID` = '$id')";

	$db->ejecutaSQL($editar_modelo);
...
<nav class="navbar navbar-expand-lg navbar-light " style=" background-color: yellow">
 	...
 	<div class="container" align="center"><br>
		<form action="#" method="POST" style="background-color: yellow; width:300px;"><br>
		<h2>Editar modelo</h2>
			<div class="form-group">
				<label for="">Marca</label><br>
				<?php 
				$cadenaid="select NombreModelo from Modelo where ModeloID='$id'";
				$ids=$db->seleccionar($cadenaid);
				$resultadoid=$ids->fetch();
			...
			<div class="form-group">
				<input value="<?php echo $resultadoid['NombreModelo']; ?>" type="text" name="nombremodelo"required autofocus> <br><br>
			<a href="../Vistas/Modificar_catalogo.php" class="btn btn-danger">Cancelar</a>
