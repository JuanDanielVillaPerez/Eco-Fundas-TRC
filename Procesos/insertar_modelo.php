...
$inserta_modelo="insert into Modelo(MarcaID,NombreModelo) values('$marcaid','$nombremodelo')";

$db->ejecutaSQL($inserta_modelo);
	...
	<div class="container" align="center"><br>
		...
		<h2>Insertar modelo</h2>
			<div class="form-group">
				<label for="">Escoja marca</label><br>
				<?php 
			...
			<div class="form-group">
				<input type="text" name="nombremodelo" placeholder="Inserte modelo" required autofocus> <br><br>
