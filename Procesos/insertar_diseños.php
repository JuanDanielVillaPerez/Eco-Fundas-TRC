...
<body style="background-color: black;">
	...
	<div class="container" align="center"><br>
		<form action="valida_diseño.php" method="POST" enctype="multipart/form-data" style="background-color: yellow; width:400px;"><br>
		<h2>Insertar diseño</h2>
			<div class="form-group">
				<label>Escoja tipo</label><br>
				<?php 
				$cadena="select * from Tipo";
				$marcas=$db->seleccionar($cadena);
				$resultado=$marcas->fetchAll();
				echo "<select name='tipo'>";
				foreach ($resultado as $value) {
					echo "<option value='".$value['TipoID']."'>".$value['Tipo']."</option>";
				}
			...
			<div class="form-group">
				<label>Nombre</label>
				<input type="text" name="nombrediseño" placeholder="Inserte nombre" required autofocus> 
			</div>
			<div class="form-group">
				<label>Imagen</label>
				<input name="imagen" id="imagen" type="file" required><br><br>
			<a href="../Vistas/Modificar_diseños.php" class="btn btn-danger">Cancelar</a>
